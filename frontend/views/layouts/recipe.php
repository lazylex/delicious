    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background: forestgreen; box-shadow: 0 0 10px rgba(0,0,0,0.5);">
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= \yii\helpers\Url::to(['/recipe/search']) ?>"><i class="glyphicon glyphicon-search"></i> Расширенный поиск</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= \yii\helpers\Url::to(['/recipe/add']) ?>"><i class="glyphicon glyphicon-plus"></i> Добавить</a>
                </li>
                <li class="nav-item">
